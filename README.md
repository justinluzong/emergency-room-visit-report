...
While founded on and driven by community-first values, in recent years the region's sudden population growth has led Maplewood Community Hospital to struggle in keeping up with rising patient demands. This project analyzes the hospital's Emergency Room patient data, with the goal of improving the overall ER patient experience.

Insights and recommendations are provided for the following key areas:
- **Patient Demographics:** Identification of notable groups among categories of gender, age group, race, and department referrals
- **Patient Satisfaction Scores:** Evaluation of score trends, both overall and among various patient demographics
...
### Patient Wait Times
- The overall average wait time is 35.3 minutes. Monthly average wait times have been on a steady decline since May 2020, with a total average decrease of 1.7 minutes through October 2020.
...
### Patient Gender
- Male and female patient counts are close to equal (4705 male and 4487 female). There are a very small amount of patients that are gender nonconforming (24 total).
...
### Patient Race
- The largest racial group is White at 2571 patients (27.9%). The second largest is African American at 1951 patients (21.1%).
- The Two or More Races patient group had the lowest average satisfaction score at 4.83, with a large amount of 0 and 1 scores.
...
- **Increase Survey Response Rate:** Encourage patients to submit a satisfaction score, either in person or through the digital correspondence channels the hospital offers (email, text, mobile app notifications, etc.) at the end of their appointment.
- **Reach Out to Low Scorers:** Follow up with patients who have submitted a low satisfaction score, to collect more detailed information about what negatively impacted their experience.
- **More Detailed Satisfaction Survey:** Instead of having patients submit only a score, develop a more detailed but concise survey for patients to take. This will allow the hospital to better identify its strengths and weaknesses.

### Catering to Unsatisfied Demographics
- **Staff Training:** Implement higher quality customer service and cultural sensitivity training programs for the hospital's ER staff. 
...
- **Increased Staffing:** If budget allows, additional staffing will also decrease wait times overall.
...
- **Patient Satisfaction Score:** The range of values for this column is 0 to 10 instead of a more typical range of 1 to 10. A large majority of the records have a Null value for this column.
